...
import friction_stopping_utils as fsu
...
VARIANTS = [
    ...
    Variant(
        version="v12",
        action_cost_weight=0.15,
        safety_cost_weight=15.0,
        crash_penalty=300.0,
        crash_remaining_penalty=300.0,
...
PRIVILEGED_GATE_MAX_CRASH_RATE = 0.10
PRIVILEGED_GATE_MIN_SUCCESS_RATE = 0.90
PRIVILEGED_GATE_MAX_PRE_BOUND_FRAC = 0.40
TRAIN_NUM_ENVS = 6
...
def _stage_cfg(
    ...
    *,
    ...
    model_params["n_steps"] = TRAIN_N_STEPS
    model_params["batch_size"] = TRAIN_BATCH_SIZE
    return cfg
...
def main() -> None:
    ...
    try:
        ...
        CONFIG_PATH.write_text(original_config)
    print("Friction-stopping v10/v11/v12 sweep finished.", flush=True)
